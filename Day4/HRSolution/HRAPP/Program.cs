...
Console.WriteLine("0: EXIT 1: Add Employee 2: Show All Employees 3:Delete Employee 4:Update Employee 5:Find By ID");
...
switch(choice)
{
    ...
    case 4:
    IEmployeeService svc4=new EmployeeService();
    EmployeesController controller4=new EmployeesController(svc4);
    Console.WriteLine("Enter Employee ID");
    controller4.Update(int.Parse(Console.ReadLine()));
    break;

    case 5:
    IEmployeeService svc5=new EmployeeService();
    EmployeesController controller5=new EmployeesController(svc5);
    Console.WriteLine("Enter the Employee ID");
    controller5.GetById(int.Parse(Console.ReadLine()));
    break;
